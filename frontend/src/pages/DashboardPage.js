...
function DashboardPage() {
  return (
    <Container>
      ...
      <p className='text-body-tertiary'>Whoever treads a path in search of knowledge, <strong>Allah</strong> will make easy for him a path to Jannah. (HR. Muslim, no. 2699)</p>
    </Container>
  );
}
